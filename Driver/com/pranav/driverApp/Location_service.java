...
GooglePlayServicesClient.OnConnectionFailedListener{
	...
	public void onLocationChanged(Location location) {
      ...
      //Getting values using sharred preferences
        SharedPreferences prfs = getSharedPreferences("com.pranav.driverapp", Context.MODE_PRIVATE);
        String uname = prfs.getString("username", "emailidplease");
        String pass=prfs.getString("password", "passwordplease");
