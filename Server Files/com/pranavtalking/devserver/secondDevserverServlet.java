...
public class secondDevserverServlet extends HttpServlet {
...
//	private static final String GOOGLE_SERVER_KEY = "AIzaSyDef5-US07A95ckj030mwMboJqVwWCQH74";
    ...
    private static final Logger log = Logger.getLogger(secondDevserverServlet.class.getName());
    ...
    try
     {
	   ...
	   //inequality filters can be applied only on one property. items  are being checked for longitude later
   
	   Filter longgt =
			   new FilterPredicate("lon",
			                       FilterOperator.LESS_THAN_OR_EQUAL,
			                       usrlon+0.25);
	   
	   Filter longlt =
			   new 	pranav@tendolkar.in	 23565FilterPredicate("lon",
			                       FilterOperator.GREATER_THAN_OR_EQUAL,
			                       usrlat-0.25);
	   Filter lonfiletr= CompositeFilterOperator.and(longgt,longlt);
